...
if (!isset($_COOKIE["mobile_recovered_bool"]))
{
...
if(isset($_POST["recover_form3"]))
{
 ...
 else
 {
  if ($_POST["new_password"] == $_POST["new_password_repeat"])
  {
   ...
   WHERE user_username = "' . $_COOKIE["mobile_recovered_username"] . '";';
...
<html>
 ...
 <div class="w3-container">
  <h2 align="center" style="font-size:10vw;">Recover Account</h2>
  <br />
  <div class="panel panel-default">
   <div class="panel-body">
    ...
    <form method="post">
     ...
     <div class="form-group">
      <center><input type="submit" name="recover_form3" id="recover_form3" class="btn btn-info" value="Recover Account" style="font-size:7vw;" /><center><br style="font-size:7vw;">
     </div>
